...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>House of Justice | Molluma</title>
    ...
    <body>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">MOLLUMA MEDICO LEGAL CENTRE</h1>
                <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Departments</a></li>
                    <li class="breadcrumb-item active text-primary">MOLLUMA MEDICO</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
                ...
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7 wow fadeInRight" data-wow-delay="0.4s">
                        <div class="section-title text-start mb-5">
                            <img style="width: 100%; height: 500px; display: block;" src="img/molluma.jpeg" class="rounded d-inline-block align-top" alt="Your Logo" />
                           
                        </div>
                    </div>
                    <div class="col-lg-5 wow fadeInRight" data-wow-delay="0.4s">
                        <div class="section-title text-start mb-5">
                            <h4 class="sub-title pe-3 mb-0">HOJ MOLLUMA MEDICO</h4>
                            <!-- <h1 class="display-3 mb-4">We are Ready to Help Improve Your Treatment.</h1> -->
                            <p class="mb-4">The Molluma Yakubu Centre for Medical Law (Molluma Medico-Legal Centre) is currently located in Kaduna in the North Central region of Nigeria. It is the first of its kind in Africa and the third in the world. The Centre addresses medical negligence, crimes and infractions that arise from the health system and offers a range of legal and para-legal services on mass atrocities cases.</p>
                            ...
                            <p class="mb-4">The Centre is named in honour of Molluma Lami Yakubu, a lawyer, writer and advocate against medical malpractice who tragically died from causes not unrelated to medical malpractice.</p>
