...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>House of Justice | Tickets</title>
    ...
    <body>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">HOJ Tickets</h1>
        ...
        <div class="container-fluid blog py-5">
            <div class="container py-5">
                <div class="section-title mb-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="sub-style">
                        <h4 class="sub-title px-3 mb-0"> Tickets</h4>
                    </div>
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-md-3 col-lg-3 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="blog-item rounded">
                            <div class="blog-img">
                                <img src="img/art1.jpg" style="height: 300px;" class="img-fluid w-100" alt="Image">
                            </div>
                            <div class="blog-centent p-4">
                                <div class="d-flex justify-content-between mb-4">
                                    <p class="mb-0 text-muted"><i class="fa fa-calendar-alt text-primary"></i> 01 Jan 2020</p>
                                    <a href="#" class="text-muted"><span class="fa fa-comments text-primary"></span> 3 Comments</a>
                                </div>
                                <a href="#" class="h4">NEWS: Group pledges support for victims of Southern Kaduna attacks and killings</a>
                                <p class="my-4"></p>
                                <a href="#" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-1">Add to Cart</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-lg-3 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="blog-item rounded">
                            <div class="blog-img">
                                <img src="img/art2.jpg" style="height: 300px;" class="img-fluid w-100" alt="Image">
                            </div>
                            <div class="blog-centent p-4">
                                <div class="d-flex justify-content-between mb-4">
                                    <p class="mb-0 text-muted"><i class="fa fa-calendar-alt text-primary"></i> 01 Jan 2020</p>
                                ...
                                <a href="#" class="h4">NEWS: HOJ to raise $250,000 to rebuild Southern Kaduna</a>
                                <p class="my-4"></p>
                                <a href="#" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-1">Add to cart</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-lg-3 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="blog-item rounded">
                            <div class="blog-img">
                                <img src="img/art1.jpg" style="height: 300px;" class="img-fluid w-100" alt="Image">
                            </div>
                            <div class="blog-centent p-4">
                                ...
                                <a href="#" class="h4">NEWS: HOJ to raise N100 million to support rebuilding of homes in Southern Kaduna</a>
                                <p class="my-4"></p>
                                <a href="#" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-1">Add to Cart</a>
                            </div>
                        </div>
