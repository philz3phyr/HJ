...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>House of Justice | R &amp P </title>
    ...
    <?php include('nav.php') ?>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">HOJ Regalia &amp Paraphernalia</h1>
                <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Pages</a></li>
                    <li class="breadcrumb-item active text-primary">Regalia &amp Paraphernalia</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
                ...
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7 wow fadeInRight" data-wow-delay="0.4s">
                        <div class="section-title text-start mb-5">
                            <img style="width: 100%; height: 500px; display: block;" src="img/regalia.jpg" class="rounded d-inline-block align-top" alt="Your Logo" />
                           
                        </div>
                    </div>
                    <div class="col-lg-5 wow fadeInRight" data-wow-delay="0.4s">
                        <div class="section-title text-start mb-5">
                            <h4 class="sub-title pe-3 mb-0">HOJ Regalia &amp Paraphernalia</h4>
