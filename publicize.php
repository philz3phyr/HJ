...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($title_err) && empty($content_err)) {
        ...
        $sql = "INSERT INTO publications (title, content, author_id, image_url, news_url) VALUES (?, ?, ?, ?, ?)";

        if ($stmt = mysqli_prepare($conn, $sql)) {
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssiss", $param_title, $param_content, $param_author_id, $param_image_url, $param_news_url);
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>House of Justice | Publicize</title>
    ...
    <body>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Publicize News</h1>
                <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Pages</a></li>
                    <li class="breadcrumb-item active text-primary">Publicize</li>
                </ol>    
            </div>
        </div>
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-12 wow fadeInLeft" data-wow-delay="0.2">
                    <div class="section-title text-start">
                        ...
                        <h1 class="display-4 mb-4">Publicize News</h1>
                        <p class="mb-4"></p>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="appointment-form rounded p-5">
                        ...
                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
                            <div class="row gy-3 gx-4">
                                ...
                                <div class="col-12">
                                    <input type="file" class="form-control border-primary bg-transparent text-dark" name="image" accept="image/*">
                                </div>
                                <div class="col-12">
                                    <input type="text" class="form-control border-primary bg-transparent text-dark" name="news_url" placeholder="News URL">
                                </div>
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary text-white w-100 py-3 px-5">Publicize</button>
                                    <a href="publications.php" class="btn btn-primary text-white w-100 py-3 px-5">CANCEL</a>
                                </div>
                            </div>
                        </form>
                    </div>
