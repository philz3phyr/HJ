...
// Define query to fetch publications from the database
$sql = "SELECT SQL_CALC_FOUND_ROWS id, title, content, created_at, image_url, news_url FROM publications ORDER BY id DESC LIMIT ?, ?";
...
// Fetch total number of publications (ignoring LIMIT) for pagination
...
<body>
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">Publications</h3>
    ...
    <div class="container-fluid blog py-5">
        <div class="container py-5">
            <div class="section-title mb-5 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="display-3 mb-4">Our Publications</h1>
                ...
                ?>
                        ...
                        <div class="col-md-9 col-lg-9 col-xl-9 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="blog-content p-4">
                                ...
                                <a href="<?php echo $row['news_url']; ?>" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-1">Read More</a>
                            </div>
                        </div>
                <?php
                    }
