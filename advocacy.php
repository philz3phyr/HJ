...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>House of Justice | ADVOCACY</title>
    ...
    <body>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">HOUSE OF JUSTICE ADVOCACY</h1>
                <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Departments</a></li>
                    <li class="breadcrumb-item active text-primary">HOUSE OF JUSTICE ADVOCACY</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.2">
                        <div class="section-title text-start">
                            <h4 class="sub-title pe-3 mb-0">HOJ Advocacy</h4>
                            <!-- <h1 class="display-4 mb-4">Best Quality Services With Minimal Pain Rate</h1> -->
                            <p class="mb-4">With our popular catch phrase: Insist on the Force of Law and not the Law of Force, House Of Justice™ takes on various campaigns and advocacy that call out injustice, give voice to victims and turn pain to purpose.</p>
