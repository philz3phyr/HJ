...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>House of Justice | TV SOCIALS</title>
    ...
    <body>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">HOJ TV</h1>
                <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Departments</a></li>
                    <li class="breadcrumb-item active text-primary">TV & SOCIALS</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
            ...
            <div class="row g-4 justify-content-center">
                    ...
                    <div class="service-item rounded">
                       <div class="rounded-top">
                            <div class="video h-100">
                                ...
                                <button type="button" class="btn btn-play" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/EEdUNb3QMQU" data-bs-target="#videoModal">
                                    <span></span>
                                </button>
                            </div>
                       </div>
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                <h6 class="mb-4">Fuel hike & implications in Nigeria</h6>
                            </div>
                            <div class="mb-4 row">
                                <div class="col-6 mb-0">
                                    <p class="mb-2"><span>30 mins </span></p>
                                </div>
                                <div class="col-6 mb-0">
                                    <p class="mb-2"><span>2024-01-01</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded">
                       <div class="rounded-top">
                        ...
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                <h6 class="mb-4">You Dont Have A Lot Of Time TO Tell Your Story</h6>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded">
                       <div class="rounded-top">
                        ...
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                <h6 class="mb-4">DRUG ABUSE, GENDER &amp; NATIONAL SECURITY</h6>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded">
                        ...
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                <h6 class="mb-2">NBC CODE & RIGHT TO FREEDOM OF EXPRESSION IN NIGERIA</h6>
                                <div class="mb-4 row">
                                    <div class="col-6 mb-0">
                                        <p class="mb-2"><span>30 mins </span></p>
                                    </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded">
                       <div class="rounded-top">
                        ...
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                <h6 class="mb-4">New Media Changing Time and Values</h6>
                                <!-- <p class="mb-4">Dolor, sit amet consectetur adipisicing elit. Soluta inventore cum accusamus, dolor qui ullam</p> -->
                            </div>
                            <div class="mb-4 row">
                                <div class="col-6 mb-0">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded">
                       <div class="rounded-top">
                        ...
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                <h6 class="mb-4">PALLIATIVES LOOT &amp; NATIONAL SECURITY</h6>
                                <!-- <p class="mb-4">Dolor, sit amet consectetur adipisicing elit. Soluta inventore cum accusamus, dolor qui ullam</p> -->
                            </div>
                            <div class="mb-4 row">
                                <div class="col-6 mb-0">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded">
                       <div class="rounded-top">
                        ...
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                <h6 class="mb-4">DSS,  MAILAFIA AND THE ACCOUNTABILITY QUESTION</h6>
                                <!-- <p class="mb-4">Dolor, sit amet consectetur adipisicing elit. Soluta inventore cum accusamus, dolor qui ullam</p> -->
                            </div>
                            <div class="mb-4 row">
                                <div class="col-6 mb-0">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded">
                       <div class="rounded-top">
                        ...
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                <h6 class="mb-4">END SARS &amp; ACCOUNTABILITY IN NIGERIA</h6>
                                <!-- <p class="mb-4">Dolor, sit amet consectetur adipisicing elit. Soluta inventore cum accusamus, dolor qui ullam</p> -->
                            </div>
                            <div class="mb-4 row">
                                <div class="col-6 mb-0">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded">
                       <div class="rounded-top">
                        ...
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                <h6 class="mb-4">INDEPENDENCE &amp; ITS MEANING TO THE NIGERIAN FEMALE</h6>
                                <!-- <p class="mb-4">Dolor, sit amet consectetur adipisicing elit. Soluta inventore cum accusamus, dolor qui ullam</p> -->
                            </div>
                            <div class="mb-4 row">
                                <div class="col-6 mb-0">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded">
                       <div class="rounded-top">
                        ...
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                <h6 class="mb-4">SARS &amp; JUSTICE IN NIGERIA</h6>
                                <!-- <p class="mb-4">Dolor, sit amet consectetur adipisicing elit. Soluta inventore cum accusamus, dolor qui ullam</p> -->
                            </div>
                            <div class="mb-4 row">
                                <div class="col-6 mb-0">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded">
                       <div class="rounded-top">
                        ...
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                <h6 class="mb-4">House of Justice with Barrister Gloria M. Ballason</h6>
                                <!-- <p class="mb-4">Dolor, sit amet consectetur adipisicing elit. Soluta inventore cum accusamus, dolor qui ullam</p> -->
                            </div>
                            <div class="mb-4 row">
                                <div class="col-6 mb-0">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded">
                       <div class="rounded-top">
                        ...
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                <h6 class="mb-4">USA, NIGERIA &amp; INTERNATIONAL SECURITY</h6>
                                <!-- <p class="mb-4">Dolor, sit amet consectetur adipisicing elit. Soluta inventore cum accusamus, dolor qui ullam</p> -->
                            </div>
                            <div class="mb-4 row">
                                <div class="col-6 mb-0">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded">
                       <div class="rounded-top">
                        ...
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                <h6 class="mb-4">Fredy Peccerelli Lecture on Accountability and Mass Killings in Nigeria</h6>
                                <!-- <p class="mb-4">Dolor, sit amet consectetur adipisicing elit. Soluta inventore cum accusamus, dolor qui ullam</p> -->
                            </div>
                            <div class="mb-4 row">
                                <div class="col-6 mb-0">
