...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>House of Justice | MIVE Legals</title>
    ...
    <body>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h3 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">MIVE LEGALS (BALLASON CHAMBERS)</h1>
                <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item"><a href="#">Departments</a></li>
                    <li class="breadcrumb-item active text-primary">MIVE LEGALS</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
                ...
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7 wow fadeInRight" data-wow-delay="0.4s">
                        <div class="section-title text-start mb-5">
                            <img style="width: 100%; height: 500px; display: block;" src="img/mive.jpeg" class="rounded d-inline-block align-top" alt="Your Logo" />
                           
                        </div>
                    </div>
                    <div class="col-lg-5 wow fadeInRight" data-wow-delay="0.4s">
                        <div class="section-title text-start mb-5">
                            <h4 class="sub-title pe-3 mb-0">HOJ MIVE Legals</h4>
                            <!-- <h1 class="display-3 mb-4">We are Ready to Help Improve Your Treatment.</h1> -->
                            <p class="mb-4">Is an A-rated litigation firm at House of Justice™. We represent local and international clients in courts of the first instance and appeals across a wide spectrum of practice areas and legal challenges at both municipal and international courts.</p>
                            <p class="mb-4">In the recent past, we have made a plethora of representations at the African Court on Human & Peoples’ Rights and the Economic Community of West African States Court of Justice (ECOWAS Court). We also represent our clients at Alternative Dispute Resolution tribunals.</p>
